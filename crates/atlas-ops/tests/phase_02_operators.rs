...
fn fp32_neural_operators_match_cpu_oracles_for_prefill_and_decode() {
    ...
    // (llama_mul_mm_q4_0_f32), and the Flash16-v4 batched prefill attention
    // (attention_prefill_gemma4_simd_q4_0_flash16_[swa_]v4) = 91.
    assert_eq!(ops.runtime().pipeline_count(), 91);
