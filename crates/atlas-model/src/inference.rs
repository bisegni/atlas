...
pub struct ResidentMetrics {
    ...
    pub selected_group_formats: Vec<crate::gemma4_executor::Gemma4SelectedGroupFormat>,
    ...
    fn generate_greedy_stream(
        ...
        Ok(InferenceGeneration {
            ...
            metrics: ResidentMetrics {
                ...
                quantization_preflight_state: result.metrics.quantization_preflight_state,
                selected_group_formats: result.metrics.selected_group_formats.clone(),
                quantization_rejections: result.metrics.quantization_rejections.clone(),
